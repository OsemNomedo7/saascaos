  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3" style={{ marginBottom: 20 }}>
        {[
          { label: 'AFILIADOS', value: affiliates.length, color: '#00d4ff' },
      ...
      {activeTab === 'affiliates' && (
        <div style={{ display: 'grid', gridTemplateColumns: selectedId ? '1fr 420px' : '1fr', gap: 16, alignItems: 'start' }}>
                    ...
                    <tr key={aff._id} style={{ borderBottom: '1px solid rgba(0,150,255,0.06)', background: selectedId === aff._id ? 'rgba(0,150,255,0.04)' : 'transparent' }}>
                        ...
                        {editingRateId === aff._id ? (
                          <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                            <input
                              ...
                              style={{ width: 52, padding: '2px 6px', ...mono, fontSize: '0.65rem', background: '#111', border: '1px solid rgba(0,150,255,0.4)', borderRadius: 3, color: '#ff8855', outline: 'none' }}
                              autoFocus
                            />
                      ...
                      <td style={{ padding: '10px 12px' }}>
                        <button onClick={() => setSelectedId(selectedId === aff._id ? null : aff._id)} style={{
                          ...
                          background: selectedId === aff._id ? 'rgba(0,150,255,0.15)' : 'rgba(0,150,255,0.08)',
          ...
          {/* Painel de detalhe */}
          {selectedId && detail && (
            <div style={{ background: '#040d18', border: '1px solid rgba(0,150,255,0.15)', borderRadius: 6, overflow: 'hidden', maxHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
              {/* Header do perfil */}
              <div style={{ padding: '12px 14px', borderBottom: '1px solid rgba(0,150,255,0.1)', background: 'rgba(0,150,255,0.04)' }}>
              ...
              <div style={{ overflowY: 'auto', flex: 1 }}>
                {/* Usuários indicados */}
                <div style={{ borderBottom: '1px solid rgba(0,150,255,0.08)' }}>
      ...
      {activeTab === 'ranking' && (
        <div style={{ background: '#040d18', border: '1px solid rgba(0,150,255,0.12)', borderRadius: 6, overflow: 'hidden' }}>
          <div style={{ padding: '12px 16px', borderBottom: '1px solid rgba(0,150,255,0.1)', display: 'flex', alignItems: 'center', gap: 8 }}>
